    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px', marginBottom: '100px' }}>
        <div style={{ aspectRatio: '4/3', borderRadius: '24px', overflow: 'hidden', border: '1px solid var(--border-color)' }}>
          <img src="https://loremflickr.com/800/600/coding,computer?lock=201" alt="Coding" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
        ...
        <div style={{ aspectRatio: '4/3', borderRadius: '24px', overflow: 'hidden', border: '1px solid var(--border-color)' }}>
          <img src="https://loremflickr.com/800/600/desk,workspace?lock=202" alt="Desk setup" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
      </div>
